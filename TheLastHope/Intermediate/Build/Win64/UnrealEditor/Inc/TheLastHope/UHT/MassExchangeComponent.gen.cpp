...
// End Cross Module References
	DEFINE_FUNCTION(UMassExchangeComponent::execUpdateActorScale)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateActorScale_Implementation(Z_Param_NewMass);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(UMassExchangeComponent::execExchangeMass)
	{
		P_GET_OBJECT(UMassExchangeComponent,Z_Param_Gainer);
		P_GET_OBJECT(UMassExchangeComponent,Z_Param_Loser);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ExchangeMass_Implementation(Z_Param_Gainer,Z_Param_Loser);
		P_NATIVE_END;
	}
	...
	struct MassExchangeComponent_eventExchangeMass_Parms
	{
		UMassExchangeComponent* Gainer;
		UMassExchangeComponent* Loser;
	};
	...
	static FName NAME_UMassExchangeComponent_ExchangeMass = FName(TEXT("ExchangeMass"));
	void UMassExchangeComponent::ExchangeMass(UMassExchangeComponent* Gainer, UMassExchangeComponent* Loser)
	{
		MassExchangeComponent_eventExchangeMass_Parms Parms;
		Parms.Gainer=Gainer;
		Parms.Loser=Loser;
		ProcessEvent(FindFunctionChecked(NAME_UMassExchangeComponent_ExchangeMass),&Parms);
	}
	...
	void UMassExchangeComponent::UpdateActorScale(float NewMass)
	{
	...
	void UMassExchangeComponent::StaticRegisterNativesUMassExchangeComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ExchangeMass", &UMassExchangeComponent::execExchangeMass },
	...
	struct Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Gainer_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Gainer;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_Loser_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_Loser;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Gainer_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Gainer = { "Gainer", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MassExchangeComponent_eventExchangeMass_Parms, Gainer), Z_Construct_UClass_UMassExchangeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Gainer_MetaData), Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Gainer_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Loser_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Loser = { "Loser", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(MassExchangeComponent_eventExchangeMass_Parms, Loser), Z_Construct_UClass_UMassExchangeComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Loser_MetaData), Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Loser_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Gainer,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::NewProp_Loser,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::Function_MetaDataParams[] = {
		{ "Category", "Mass Exchange" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "// Exchanges Mass\n" },
#endif
		{ "ModuleRelativePath", "MassExchangeComponent.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Exchanges Mass" },
#endif
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UMassExchangeComponent, nullptr, "ExchangeMass", nullptr, nullptr, Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::PropPointers), sizeof(MassExchangeComponent_eventExchangeMass_Parms), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x0C020C00, 0, 0, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::Function_MetaDataParams), Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::Function_MetaDataParams) };
	static_assert(UE_ARRAY_COUNT(Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::PropPointers) < 2048);
	static_assert(sizeof(MassExchangeComponent_eventExchangeMass_Parms) < MAX_uint16);
	UFunction* Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UMassExchangeComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UMassExchangeComponent_ExchangeMass, "ExchangeMass" }, // 3382782622
		...
		{ &Z_Construct_UFunction_UMassExchangeComponent_UpdateActorScale, "UpdateActorScale" }, // 1393548918
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_anish_Documents_GitHub_2025EpicMegaJam_TheLastHope_Source_TheLastHope_MassExchangeComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMassExchangeComponent, UMassExchangeComponent::StaticClass, TEXT("UMassExchangeComponent"), &Z_Registration_Info_UClass_UMassExchangeComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMassExchangeComponent), 3051264437U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_anish_Documents_GitHub_2025EpicMegaJam_TheLastHope_Source_TheLastHope_MassExchangeComponent_h_1941468927(TEXT("/Script/TheLastHope"),
